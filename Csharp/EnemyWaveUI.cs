...
public class EnemyWaveUI : MonoBehaviour
{
    ...
    private void HandleEnemyWaveSpawnPositionIndicator()
    {
        ...
        Vector3 dirToNextSpawnPostion = (enemyWaveManager.GetSpawnPosition() - mainCamera.transform.position).normalized;

        enemyWaveSpawnPositionIndicator.anchoredPosition = dirToNextSpawnPostion * 300f;
        enemyWaveSpawnPositionIndicator.eulerAngles = new Vector3(0, 0, UtilsClass.GetAngleFromVector(dirToNextSpawnPostion));
